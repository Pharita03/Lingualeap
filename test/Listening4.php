...
<body class="exam">
    ...
    <main>
        <div class="Test" id="test1">
            ...
            <div class="Test1">
                <div class="detail">
                    <h4>Listening flow 4: listening question</h4>
                </div>
                    ...
                    <div class="question hidden" id="question-1">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 1.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-2">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 2.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                    ...
                    <div class="question hidden" id="question-3">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 3.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                    ...
                    <div class="question hidden" id="question-4">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 4.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-5">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 5.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-6">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 6.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-7">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 7.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-8">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 8.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-9">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 9.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-10">
                        <div class="img">
                            <div class="box">
                                ...
                                <audio controls class="audio"><source src="../unit/unit3/listening/Unit 4 Recording 10.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
