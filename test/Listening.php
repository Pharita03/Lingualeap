...
<body class="exam">
    ...
    <main>
        <div class="Test" id="test1">
            ...
            <div class="Test1">
                <div class="detail">
                    <h4>Listening flow 1: listening question</h4>
                    <a href="../test/score.php"><button class="btn">See your score</button></a>
                </div>
            ...
            <form  id="quiz-form" action="../test/score.php" method="POST">
                    <div class="question hidden" id="question-1">
                        <div class="img">
                            <div class="box">
                                1.
                                <img src="../unit/unit1/img/L1.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 1.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-2">
                        <div class="img">
                            <div class="box">
                                2.
                                <img src="../unit/unit1/img/L2.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 2.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                    ...
                    <div class="question hidden" id="question-3">
                        <div class="img">
                            <div class="box">
                                3.
                                <img src="../unit/unit1/img/L3.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 3.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                    ...
                    <div class="question hidden" id="question-4">
                        <div class="img">
                            <div class="box">
                                4.
                                <img src="../unit/unit1/img/L4.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 4.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-5">
                        <div class="img">
                            <div class="box">
                                5.
                                <img src="../unit/unit1/img/L5.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 5.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                    ...
                    <div class="question hidden" id="question-6">
                        <div class="img">
                            <div class="box">
                                6.
                                <img src="../unit/unit1/img/L6.jpg">
                                <audio controls class="audio"><source src="../unit/unit1/Unit 1 Listening 6.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
