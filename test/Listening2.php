...
<body class="exam">
    ...
    <main>
        <div class="Test" id="test1">
            ...
            <div class="Test1">
                <div class="detail">
                    <h4>Listening flow 2: listening question</h4>
                </div>
            ...
            <form  id="quiz-form" action="../test/score.php" method="POST">
                    <div class="question hidden" id="question-1">
                        <div class="img">
                            <div class="box">
                                1.
                                <img src="../unit/unit2/listening/img/Picture1.jpg">
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 1.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                                ...
                                <label><input type="radio" name="1" value="D"> D </label>
                            </div>
                        </div>
                    </div>
                    <div class="question hidden" id="question-2">
                        <div class="img">
                            <div class="box">
                                2.
                                <img src="../unit/unit2/listening/img/Picture2.jpg">
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 2.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                                ...
                                <label><input type="radio" name="2" value="D"> D </label>
                            </div>
                        </div>
                    </div>
                    <div class="question hidden" id="question-3">
                        <div class="img">
                            <div class="box">
                                3.
                                <img src="../unit/unit2/listening/img/Picture3.jpg">
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 3.m4a" type="audio/mpeg"></audio>
                            </div>
                                <div class="options">
                                ...
                                <label><input type="radio" name="3" value="D"> D </label>
                            </div>
                        </div>
                    </div>
                    <div class="question hidden" id="question-4">
                        <div class="img">
                            <div class="box">
                                4.
                                <img src="../unit/unit2/listening/img/Picture4.jpg">
                        
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 4.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                                ...
                                <label><input type="radio" name="4" value="D"> D </label>
                            </div>
                        </div>
                    </div>
                    <div class="question hidden" id="question-5">
                        <div class="img">
                            <div class="box">
                                5.
                                <img src="../unit/unit2/listening/img/Picture5.jpg">
                            
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 5.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                                ...
                                <label><input type="radio" name="5" value="D"> D </label>
                            </div>
                        </div>
                    </div>
                    <div class="question hidden" id="question-6">
                        <div class="img">
                            <div class="box">
                                6.
                                <img src="../unit/unit2/listening/img/Picture6.jpg">
                                <audio controls class="audio"><source src="../unit/unit2/listening/Unit 2 Recording 6.m4a" type="audio/mpeg"></audio>
                            </div>
                            <div class="options">
                                ...
                                <label><input type="radio" name="6" value="D"> D </label>
                            </div>
                        </div>        
                    </div>
